...
export default async function Page() {
	...
	if (!checkout || checkout.lines.length < 1) {
		return (
			<section className="mx-auto max-w-7xl rounded-lg bg-black p-8 text-white">
				<h1 className="mt-8 text-3xl font-bold text-white">Your Shopping Cart is empty</h1>
				<p className="my-12 text-sm text-white">Looks like you haven’t added any items to the cart yet.</p>
				<Link
					href="/products"
	...
	return (
		<section className="mx-auto max-w-7xl rounded-lg bg-black p-8 text-white">
			<h1 className="mt-8 text-3xl font-bold text-white">Your Shopping Cart</h1>
			<form className="mt-12">
						...
						<li key={item.id} className="flex py-4">
							...
							<div className="relative flex flex-1 flex-col justify-between p-4 py-2">
								...
								<div className="flex justify-between">
									<div className="text-sm font-bold text-white">Qty: {item.quantity}</div>
				...
				<div className="mt-12">
					<div className="rounded border border-white bg-black px-4 py-2">
						<div className="flex items-center justify-between gap-2 py-2">
							<div>
								<p className="font-semibold text-white">Your Total</p>
								<p className="mt-1 text-sm text-white">Shipping will be calculated in the next step</p>
							</div>
